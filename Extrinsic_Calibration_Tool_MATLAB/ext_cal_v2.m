...
[ext, cost] = Calib_Opt_Fun_v2(Yc, Yr, x0, camera_intrinsic);

for i = 1:50
    [ext, cost] = Calib_Opt_Fun_v2(Yc, Yr, ext, camera_intrinsic);
end
...
ext_par = opt_ext(1:6);  %[yaw, pitch, roll, X, Y, Z]
cam_int = opt_ext(7:9);  %[foc, u0, v0]

save ext_par.mat ext_par;
